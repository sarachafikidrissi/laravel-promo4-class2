...
@section('content')
    ...
    <h2 class="text-2xl font-medium mb-4">Create Product</h2>
    <form action="/product/store" method="post">
        ...
        <div class="mb-4">
            ...
            <input type="number" id="age" name="price"
                class="border border-gray-400 p-2 w-full rounded-lg focus:outline-none focus:border-blue-400" required>
        </div>
        <div class="mb-4">
            <label for="age" class="block text-gray-700 font-medium mb-2">Stock</label>
            <input type="number" id="age" name="stock"
                class="border border-gray-400 p-2 w-full rounded-lg focus:outline-none focus:border-blue-400" required>
        </div>
            ...
            <div class="flex flex-wrap -mx-2">
                <div class="px-2 w-1/3">
                    <label for="animal-cat" class="block text-gray-700 font-medium mb-2">
                        <input type="checkbox" id="animal-cat" name="sizes[]" value="s" class="mr-2">S
                    </label>
                </div>
                <div class="px-2 w-1/3">
                    <label for="animal-dog" class="block text-gray-700 font-medium mb-2">
                        <input type="checkbox" id="" name="sizes[]" value="m"
                            class="mr-2">M
                    </label>
                </div>
                <div class="px-2 w-1/3">
                    <label for="animal-bird" class="block text-gray-700 font-medium mb-2">
                        <input type="checkbox" id="animal-bird" name="sizes[]" value="l" class="mr-2">L
                    </label>
                </div>
            </div>
        </div>
